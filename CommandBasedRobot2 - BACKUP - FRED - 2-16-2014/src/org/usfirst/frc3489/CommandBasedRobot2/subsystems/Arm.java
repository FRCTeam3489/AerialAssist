...
public class Arm extends Subsystem {
    ...
    Solenoid bottomArmSol = RobotMap.armPosBottom;
    Solenoid topArmSol = RobotMap.armPosTop;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new ArmVerticalPosition());
    ...
    public void shootingPosition() {
        topArmSol.set(true);
        bottomArmSol.set(false);
    }
    
    public void lowGoalPosition() {
        bottomArmSol.set(true);
        topArmSol.set(false);
    }
