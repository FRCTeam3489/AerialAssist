 ...
 *
 */
public class ClawLoader extends Subsystem {
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    SpeedController loaderMotor = RobotMap.armLoaderMotor;
    DigitalInput loadingLimit = RobotMap.armLoadingLimit;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new WheelLoaderDoNothing());
