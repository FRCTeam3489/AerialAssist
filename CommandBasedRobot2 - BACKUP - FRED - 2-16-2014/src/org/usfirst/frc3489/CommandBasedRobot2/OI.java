...
public class OI {
    ...
    public OI() {
        ...
        clawLoaderEjectButton = new JoystickButton(joystick3, 4);
        clawLoaderEjectButton.whileHeld(new WheelLoaderBackdrive());
        
        clawLoaderInsertButton = new JoystickButton(joystick3, 3);
        ...
        tractionWheelsUpButton = new JoystickButton(joystick2, 3);
        tractionWheelsUpButton.whenPressed(new TractionUp());
        
        tractionWheelsDownButton = new JoystickButton(joystick2, 2);
        tractionWheelsDownButton.whenPressed(new TractionDown());
        
        joystick1 = new Joystick(1);
        midwheelDownButton = new JoystickButton(joystick1, 2);
